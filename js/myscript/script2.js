		...
		var winCount = parseInt(localStorage.getItem('winCount'));
			...
			setTimeout(function() {
				for(var k = 0; k < winners.length; k++) {
					$('#gen'+(k+1)).show(); // showing some divs which were unshowed

					$('#code-country'+(k+1)+"-1").html(5);
					$('#code-country'+(k+1)+"-2").html(9);
					$('#first-nums'+(k+1)+"-1").html(7);
					$('#first-nums'+(k+1)+"-2").html(4);
					$('#first-nums'+(k+1)+"-3").html(8);			  
					$('#second-nums'+(k+1)+"-1").html(9);
					$('#second-nums'+(k+1)+"-2").html(5);
					$('#third-nums'+(k+1)+"-1").html(9);
					$('#third-nums'+(k+1)+"-2").html(7);
				}
			}, 2500);

			setTimeout(function() {
				for(var k = 0; k < winners.length; k++) {
					$('#code-country'+(k+1)+"-1").html(9);
					$('#code-country'+(k+1)+"-2").html(3);
					$('#first-nums'+(k+1)+"-1").html(2);
					$('#first-nums'+(k+1)+"-2").html(8);
					$('#first-nums'+(k+1)+"-3").html(5);			  
					$('#second-nums'+(k+1)+"-1").html(9);
					$('#second-nums'+(k+1)+"-2").html(0);
					$('#third-nums'+(k+1)+"-1").html(2);
			...
			setTimeout(function() {
				for(var k = 0; k < winners.length; k++) {
					$('#code-country'+(k+1)+"-1").html(4);
					$('#code-country'+(k+1)+"-2").html(7);				
					$('#first-nums'+(k+1)+"-1").html(7);
					...
					$('#third-nums'+(k+1)+"-2").html(9);				
				}
			}, 4500);

			setTimeout(function() {
				for(var k = 0; k < winners.length; k++) {
					$('#code-country'+(k+1)+"-1").html(2);
					$('#code-country'+(k+1)+"-2").html(0);
					$('#first-nums'+(k+1)+"-1").html(3);
					$('#first-nums'+(k+1)+"-2").html(8);
					$('#first-nums'+(k+1)+"-3").html(9);			  
					$('#second-nums'+(k+1)+"-1").html(7);
					$('#second-nums'+(k+1)+"-2").html(1);
			...
			setTimeout(function() {
				for(var k = 0; k < winners.length; k++) {
					...
					$('#code-country'+(k+1)+"-1").html(str[3]);
					$('#code-country'+(k+1)+"-2").html(str[4]);
